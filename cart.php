...
echo '<tr><td><b>TOTAL</td><td><b>AMOUNT</td><td width="100"><U><B>'.$sum.'.00</td><td align="center"><a href="OrderStatus.php?action=ref" class="style3">Buy Now!</a></td></tr></table></div>';
}
else
{
$cart = $_SESSION['CartItem'];
