...
echo '<td><a href="cart.php?action=add&id='.$row['ItemName'].'&To=MobPhone&price='.$row['ItemPrice'].'&url='.$row['ItemUrl'].'" class="style3">Add to Cart</a></td>';
echo '</tr>';
